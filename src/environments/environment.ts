...
// let baseURL:any = 'https://u34api.getwow.education/api/';
export const environment = {
  production: false,
  /*-------------------------popup's--------------------------------*/
  // access_popup:'https://p10.getwow.community',
  // assign_to_students_popup:'https://p14.getwow.community',
  // link_new_popup:'https://p17.getwow.community',
 // * ----------------------- ceph -----------------------* //
