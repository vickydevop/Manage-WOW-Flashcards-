...
@Component({
  selector: 'app-your-wow-fc-tree-view',
  templateUrl: './your-wow-fc-tree-view.component.html',
  styleUrls: ['./your-wow-fc-tree-view.component.scss']
})
export class YourWowFcTreeViewComponent implements OnInit {
  ...
  tree_view_checkbox() {
    ...
    let data: any = {
      receive_data_from_parent: this.receive_data_from_parent,
      selected_syllabus_id: this.selected_syllabus_id
    }
        this.get_output_data.emit({ table_data: data, selected_syllabus_id: this.selected_syllabus_id });
    // this._apiService.GetTableDataBasedOnAboveSelectedRelevantSyllabusAndSyllabusId(data).subscribe({
    //   next: (res) => {
    //     // console.log(res,'res');
