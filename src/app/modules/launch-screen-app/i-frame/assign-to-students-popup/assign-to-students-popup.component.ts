...
@Component({
  selector: 'app-assign-to-students-popup',
  templateUrl: './assign-to-students-popup.component.html',
  styleUrls: ['./assign-to-students-popup.component.scss']
})
export class AssignToStudentsPopupComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  iframeSource: string = 'https://p14.getwow.community';
  // iframeSource: string = 'https://p14.getwow.education';
  ...
  constructor(
    ...
    public _dialogRef: MatDialogRef<AssignToStudentsPopupComponent>,
