...
@Component({
  selector: 'app-mone-earning-details-table-two',
  templateUrl: './mone-earning-details-table-two.component.html',
  styleUrls: ['./mone-earning-details-table-two.component.scss']
})
export class MoneEarningDetailsTableTwoComponent implements OnInit {
